      ...
      <div className="container-custom">
            ...
            return (
              <ScrollReveal key={i} delay={i * 150}>
                <div className={`${widths[i]} mx-auto`}>
                  <div
                    className={`border rounded-xl p-6 md:p-8 ${tierColors[i]} transition-all duration-300 hover:scale-[1.02]`}
                  >
        ...
        <ScrollReveal delay={500}>
          <div className="mt-10 text-center">
            <div className="inline-flex items-center gap-2 bg-white/[0.03] border border-white/10 rounded-full px-6 py-3">
              <svg
